    ...
    def __init__(self, game_row):
        ...
        if self.visitor_team_is_money_line_favorite:
            if self.v_money_line_close < self.v_money_line_open:
                ...
                self.visitor_team_is_money_line_public_and_vegas_favorite = False
        else:
            if self.h_money_line_close < self.h_money_line_open:
                self.home_team_is_money_line_public_and_vegas_favorite = True
            else:
                self.home_team_is_money_line_public_and_vegas_favorite = False
